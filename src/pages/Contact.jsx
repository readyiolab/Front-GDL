      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
          ...
          <div className="lg:col-span-2 bg-white border border-gray-100 rounded-lg p-8 animate-slide-in">
            ...
            {submitted ? (
              <div className="flex items-center gap-2 text-teal-600 bg-teal-50 p-4 rounded-lg mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-teal-600 hover:bg-teal-700 h-10 text-base transition-transform duration-300 hover:scale-105"
                >
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:support@healthwellness.com" className="text-sm text-teal-600 hover:underline">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+18001234567" className="text-sm text-teal-600 hover:underline">
                    +1 (800) 123-4567
                  </a>
                </div>
              </div>
